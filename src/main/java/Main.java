...
public class Main {
    ...
    public static int[] findLargestAndSmallest(int[] array) {
        ...
        return new int[]{array[minIndex], array[maxIndex]};
    }
    ...
    public static int sumOfTwoLargest(int[] array) {
        ...
        int largestIndex = array[0]>= array[1]? 0 : 1;
        int secondLargestIndex = largestIndex == 1 ? 0 : 1;
        ...
        return array[largestIndex] + array[secondLargestIndex];
    }
